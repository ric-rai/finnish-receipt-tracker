...
public final class MappingUtils {
    /**
     * Luo annetuista olioargumenttipareista Map-olion. Argumenttien määrän tulee olla parillinen; ensimmäisestä
    ...
    public static <V> Map<String, V> toStrMap(Object... p) {
        return IntStream.range(0, p.length / 2)
                ...
                .filter((e) -> e[1] != null)
                .collect(Collectors
                        .toMap(e -> String.valueOf(e[0]), e -> (V) e[1]));
    }
     ...
     * Statement -luokan mahdollisesti heittämät poikkeukset jätetään huomioimatta.
     *
     ...
     * arvon. Oliolla on oltava kyseiselle attribuutille asetettu Java Beans -käytännön mukainen get-metodi. Expression
     * -luokan mahdollisesti heittämät poikkeukset jätetään huomioimatta.
     *
    ...
    private static Object getProperty(Object target, String getterName) {
